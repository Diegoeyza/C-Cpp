...
int id(int piece){  //funcion para asignarle un valor a la letra que entrega el usuario, lo podría hacer usando el valor de la tabla del carácter y restarle A, pero esto fallaría si ingreso minúsculas
    if (piece=='a'||piece=='A'){
        return 0;
    }
